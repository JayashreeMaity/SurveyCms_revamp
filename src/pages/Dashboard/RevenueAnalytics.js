            ...
            <React.Fragment>
                <Card>
                    <CardBody>
                        ...
                        <h4 className="card-title mb-2">Users Analytics</h4>
                        ...
                        <Row>
                            <Col sm={4}>
                                <div className="d-inline-flex">
                                    <h5 className="me-2">2000</h5>
                                    <div className="text-success">
                                        <i className="mdi mdi-menu-up font-size-14"> </i>2.2 %
                                    </div>
                                </div>
                                <p className="text-muted text-truncate mb-0">User Reached This month</p>
                            </Col>

                            <Col sm={4}>
                                <div className="mt-4 mt-sm-0">
                                    <p className="mb-2 text-muted text-truncate"><i className="mdi mdi-circle text-primary font-size-10 me-1"></i> User Reached This Year :</p>
                                    <div className="d-inline-flex">
                                        <h5 className="mb-0 me-2">10000</h5>
                                        <div className="text-success">
                            ...
                            <Col sm={4}>
                                <div className="mt-4 mt-sm-0">
                                    <p className="mb-2 text-muted text-truncate"><i className="mdi mdi-circle text-success font-size-10 me-1"></i> User reached Previous Year :</p>
                                    <div className="d-inline-flex">
