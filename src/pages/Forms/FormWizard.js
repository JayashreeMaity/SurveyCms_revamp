...
class FormWizard extends Component {
    ...
    <div id="progrss-wizard" className="twitter-bs-wizard">
        <Row>
            <Col md="3">
                {/* Vertical navigation */}
                <ul className="twitter-bs-wizard-nav nav flex-column">
                    <NavItem>
                        <NavLink className={classnames("step-link", { active: this.state.activeTabProgress === 1 })} onClick={() => { this.toggleTabProgress(1); }}>
                            <span className="step-number">01</span>
                            <span className="step-title">Seller Details</span>
                        </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink className={classnames("step-link", { active: this.state.activeTabProgress === 2 })} onClick={() => { this.toggleTabProgress(2); }}>
                            <span className="step-number">02</span>
                            <span className="step-title">Company Document</span>
                        </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink className={classnames("step-link", { active: this.state.activeTabProgress === 3 })} onClick={() => { this.toggleTabProgress(3); }}>
                            <span className="step-number">03</span>
                            <span className="step-title">Bank Details</span>
                        </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink className={classnames("step-link", { active: this.state.activeTabProgress === 4 })} onClick={() => { this.toggleTabProgress(4); }}>
                            <span className="step-number">04</span>
                            <span className="step-title">Confirm Detail</span>
                        </NavLink>
                    </NavItem>
            ...
            <Col md="9">
                ...
                <ul className="pager wizard twitter-bs-wizard-pager-link">
                    <li className={this.state.activeTabProgress === 1 ? "previous disabled" : "previous"}>
                        <Link to="#" onClick={() => { this.toggleTabProgress(this.state.activeTabProgress - 1); }}>Previous</Link>
                    </li>
                    <li className={this.state.activeTabProgress === 4 ? "next disabled" : "next"}>
                        <Link to="#" onClick={() => { this.toggleTabProgress(this.state.activeTabProgress + 1); }}>Next</Link>
                    </li>
                </ul>
            </Col>
        </Row>
