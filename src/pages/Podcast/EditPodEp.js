...
function EditPodEp() {
    ...
    const handleEpisodeFileChange = async (event, episodeIndex, fieldName) => {
        ...
        const allowedFileTypes = ['image/jpeg', 'image/webp', 'image/png', 'audio/mpeg', 'audio/mp4', "audio/mp3"];  // Adjust this array for other audio formats
        const maxSizeKB = 500;
    ...
    const handleFileChange = async (event, fieldName) => {
        const file = event.target.files[0];
        const fileType = file.type.split('/')[1];
        const allowedFileTypes = ['image/jpeg', 'image/webp', 'image/png', 'audio/mpeg', 'audio/mp4', "audio/mp3"];
    ...
    //                 onChange={(e) => handleFormChange({ target: { name: 'episode_slug', value: e.target.value } }, index)}
    //             />
    ...
    //                     marginBottom: "4px"
    //                 }}>
    //                     <source src={trailerEpAudioPreview} type="audio/mpeg" />
    //                     <source src={trailerEpAudioPreview} type="audio/mp4" />
    //                     <source src={trailerEpAudioPreview} type="audio/mp3" />
    ...
    //         placeholderText="Episode Date"
    //         name="episode_publish_date"
    //         selected={episode && episode?.episode_publish_date ? new Date(episode?.episode_publish_date) : null}
    ...
    //                 onChange={(e) => handleFormChange(e, index)}
    //             />
    //             <label htmlFor={`episode_season_${index}`}>Episode Name</label>
    //             <Input
    //                 type="text"
    ...
    //                 onChange={(e) => handleFormChange(e, index)}
    //             />
    //             <label htmlFor={`episode_sorting_${index}`}>Episode Sorting</label>
    //             <Input
    //                 type="text"
    //                 id={`episode_sorting_${index}`}
    //                 placeholder="Episode Sorting"
    //                 name="episode_sorting"
    //                 value={episode.episode_sorting}
    //                 onChange={(e) => handleFormChange(e, index)}
    //             />
    //             <label htmlFor={`episode_publish_date_${index}`}>Episode Publish Date</label>
    //             <DatePicker
            ...
            <div key={index}>
                <>
                    ...
                    <TimePicker
                        ...
                        value={episode.episode_publish_time ? moment(episode.episode_publish_time, 'h:mm A') : null}
                        onChange={(time, timeString) => {
                            handleFormChange({ target: { name: 'episode_publish_time', value: timeString } }, index)
                        }}
                    />
                </>
            </div>
